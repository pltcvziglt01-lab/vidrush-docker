...
🧠 `/senkron` verdiğin METNİN (her dilde) her cümlesi için yönetmen
kalitesinde prompt üretir — tüm video için TEK stil anayasası + tutarlı
karakter tanımı; girişin ilk ~4-5k karakteri tamamen video — Flow'da
oluşturur ve her çıktıyı dayandığı cümleyle Telegram'a atar.
