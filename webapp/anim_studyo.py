...
def _tr_ozet(sr: dict) -> dict:
    ...
    return {
        ...
        # 16 alanin TAMAMI ozete girer — kullanici motorun ne anladigini gormeden
        # onaylayamaz. (Once sadece 8 alan yaziliyordu, yeni alanlar gorunmuyordu.)
        "stil": {
            ...
            "kontrast": st.get("kontrast", ""),
            "detay": st.get("detay", ""),
            "arka_plan_yogunlugu": st.get("arka_plan", ""),
            "karakter_cizim": st.get("karakter_cizim", ""),
            "oranlar": st.get("oranlar", ""),
            "renk_uyumu": st.get("renk_uyumu", ""),
            "yazi": st.get("yazi", ""),
            "ruh": st.get("ruh", ""),
            "kacinilacak": st.get("kacinilacak", ""),
            "guven": st.get("_guven"),
        },
