...
TAM = {
    ...
    "kaynak_kullanimi": {"en_uzun_sn": 7.4, "kimlik_eksik": 0,
                         "olculdu": True},
    "kaynak_ses": {"rms_db": -91.0, "olculdu": True},
    ...
    "ducking": {"derinlik_db": -9.0, "olculdu": True},
...
VAKALAR = [
    ...
    ("kaynak sesi duyuluyor", boz("kaynak_ses.rms_db", -12.0),
     "KABUL-KAYNAK-SES"),
    ("kaynak sesi olculmedi", boz("kaynak_ses.olculdu", False),
     "KABUL-KAYNAK-SES"),
    ("kaynak sesi beyan (deger yok)", boz("kaynak_ses.rms_db", None),
     "KABUL-KAYNAK-SES"),
